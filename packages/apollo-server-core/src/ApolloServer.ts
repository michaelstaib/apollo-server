...
import { plugin as pluginCacheControl, CacheControlExtensionOptions } from "apollo-cache-control";
...
export class ApolloServerBase {
  ...
  private ensurePluginInstantiation(plugins?: PluginDefinition[]): void {
    ...
    console.log('era', this.engineReportingAgent);
    console.log('get fucked', this.schema && this.schemaIsFederated(this.schema));

    const schemaIsFederated =
      !this.config.gateway && this.schema && this.schemaIsFederated(this.schema)
        ? true
        : false;

        console.log("schema is federated", schemaIsFederated);
        console.log(this.engineServiceId);
    ...
    if (this.engineReportingAgent) {
      ...
      console.log('adding the non-federated extension');
      ...
      console.log('schema is federated');
